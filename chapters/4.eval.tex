...
\begin{figure}[h]
  ...
  \caption{โครงสร้างไฟล์ Unit Test ใน Feature Module แสดง usecase.go, mock\_test.go และ usecase\_test.go}
  \label{fig:test-structure}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=.80\linewidth]{chapters/images/floppa.png}
  \caption{ผลการรัน CI Pipeline ผ่าน GitHub Actions แสดงสถานะ test ผ่านทุก module}
  \label{fig:ci-result}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.80\linewidth]{chapters/images/floppa.png}
  \caption{ผลการประเมินความง่ายในการใช้งาน (Ease of Use) จากผู้ทดสอบ 11 คน}
  \label{fig:uat-ease}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=.80\linewidth]{chapters/images/floppa.png}
  \caption{ผลการประเมินความพึงพอใจโดยรวมและความน่าจะเป็นในการใช้งานต่อ}
  \label{fig:uat-satisfaction}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=.80\linewidth]{chapters/images/floppa.png}
  \caption{ผลการประเมินความรู้สึกต่อดีไซน์และ UI/UX ของแอป GymMate}
  \label{fig:uat-design}
\end{figure}
